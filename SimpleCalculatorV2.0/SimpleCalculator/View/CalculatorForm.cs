...
namespace SimpleCalculator.View
{
    public partial class CalculatorForm : Form, ICalculatorFormViewable
    {
        ...
        private void CalculatorForm_HandleCreated(object sender, System.EventArgs e)
        {
            _presenter.OnHandlerCreated();
        }
        private void CalculatorForm_HandleDestroyed(object sender, System.EventArgs e)
        {
